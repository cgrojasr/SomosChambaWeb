...
import { PostulanteRegistroCompletado } from './postulante-registro-completado';

describe('PostulanteRegistroCompletado', () => {
  let component: PostulanteRegistroCompletado;
  let fixture: ComponentFixture<PostulanteRegistroCompletado>;

  beforeEach(async () => {
    localStorage.clear();

    await TestBed.configureTestingModule({
      imports: [PostulanteRegistroCompletado],
    }).compileComponents();

    fixture = TestBed.createComponent(PostulanteRegistroCompletado);
  ...
  it('debe cargar perfil guardado al reiniciar el componente', async () => {
    ...
    const newFixture = TestBed.createComponent(PostulanteRegistroCompletado);
