...
export class PostulanteRegistroCompletado {
  ...
  readonly tituloSeccion = computed(() =>
    this.perfilGuardado() ? 'Completa o actualiza tu perfil' : 'Completa tu perfil'
  );
  ...
  private obtenerValorFormularioLimpio(): { fullName: string; district: string; birthDate: string; experience: string } {
